...
SECRET_KEY = 'django-insecure-59x&ithgd6&6&p@2k_+#1sr8w04%-+!6%*5(379z$z&f)4p3gq'
...
TEMPLATES = [
    {
        ...
        'DIRS': ["D:\\Documentos\\Programación\\Entornos_virtuales\\Mi_web\\src\\proyecto\\base\\templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
